...
urlpatterns = [
    ...
    path('staffs/', close_login_required(views.staff_list), name='staff_list'),
    path('staffs/new/', close_login_required(views.staff_create), name='staff_create'),
    path('staffs/import/', close_login_required(views.staff_import), name='staff_import'),
    path('staffs/<int:pk>/edit/', close_login_required(views.staff_edit), name='staff_edit'),
    path('staffs/<int:pk>/delete/', close_login_required(views.staff_delete), name='staff_delete'),
    path('linked-persons/', close_login_required(views.linked_person_list), name='linked_person_list'),
    path('linked-persons/new/', close_login_required(views.linked_person_create), name='linked_person_create'),
    path('linked-persons/import/', close_login_required(views.linked_person_import), name='linked_person_import'),
    path('linked-persons/<int:pk>/edit/', close_login_required(views.linked_person_edit), name='linked_person_edit'),
    path('linked-persons/<int:pk>/delete/', close_login_required(views.linked_person_delete), name='linked_person_delete'),
    path('families/', close_login_required(views.family_list), name='family_list'),
    path('families/new/', close_login_required(views.family_create), name='family_create'),
    path('families/import/', close_login_required(views.family_import), name='family_import'),
    path('families/<int:pk>/edit/', close_login_required(views.family_edit), name='family_edit'),
    path('families/<int:pk>/delete/', close_login_required(views.family_delete), name='family_delete'),
    path('guardians/', close_login_required(views.guardian_list), name='guardian_list'),
    path('guardians/new/', close_login_required(views.guardian_create), name='guardian_create'),
    path('guardians/import/', close_login_required(views.guardian_import), name='guardian_import'),
    path('guardians/<int:pk>/edit/', close_login_required(views.guardian_edit), name='guardian_edit'),
    path('guardians/<int:pk>/delete/', close_login_required(views.guardian_delete), name='guardian_delete'),
