...
urlpatterns = [
    ...
    path('patients/', close_login_required(views.patient_list), name='patient_list'),
    path('patients/new/', close_login_required(views.patient_create), name='patient_create'),
    path('patients/import/', close_login_required(views.patient_import), name='patient_import'),
    path('patients/<int:pk>/edit/', close_login_required(views.patient_edit), name='patient_edit'),
    path('patients/<int:pk>/delete/', close_login_required(views.patient_delete), name='patient_delete'),
    ...
    path('templates/<int:pk>/toggle-active/', close_login_required(views.template_toggle_active), name='template_toggle_active'),
    path('templates/<int:pk>/delete/', close_login_required(views.template_delete), name='template_delete'),
    path('templates/reorder/', close_login_required(views.template_reorder), name='template_reorder'),
    path('templates/<str:template_type>/fields/', close_login_required(views.template_input_fields_edit), name='template_input_fields_edit'),
